...
type File struct {
	...
	PkgPath      string
	GoPackage    string
	// TODO: this includes imports, but they should be separate so they can be
	// printed outside of any section when the file doesn't use any particular
	// FFI. See https://github.com/tchajed/goose/issues/31.
	Decls []Decl
}
