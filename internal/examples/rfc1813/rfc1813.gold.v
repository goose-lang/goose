...
Definition Fattr3 := struct.decl [
  ...
  "Size" :: Size3;
  "Used" :: Size3;
  "Rdev" :: structT Specdata3;
  "Fsid" :: Uint64;
  "Fileid" :: Fileid3;
  "Atime" :: structT Nfstime3;
  "Mtime" :: structT Nfstime3;
  "Ctime" :: structT Nfstime3
].

Definition Post_op_attr := struct.decl [
  "Attributes_follow" :: boolT;
  "Attributes" :: structT Fattr3
].
...
Definition Pre_op_attr := struct.decl [
  "Attributes_follow" :: boolT;
  "Attributes" :: structT Wcc_attr
].

Definition Wcc_data := struct.decl [
  "Before" :: structT Pre_op_attr;
  "After" :: structT Post_op_attr
].

Definition Post_op_fh3 := struct.decl [
  "Handle_follows" :: boolT;
  "Handle" :: structT Nfs_fh3
].
...
Definition Sattr3 := struct.decl [
  "Mode" :: structT Set_mode3;
  "Uid" :: structT Set_uid3;
  "Gid" :: structT Set_gid3;
  "Size" :: structT Set_size3;
  "Atime" :: structT Set_atime;
  "Mtime" :: structT Set_mtime
].
...
Definition GETATTR3args := struct.decl [
  "Object" :: structT Nfs_fh3
].

Definition GETATTR3resok := struct.decl [
  "Obj_attributes" :: structT Fattr3
].

Definition GETATTR3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT GETATTR3resok
].

Definition Sattrguard3 := struct.decl [
  "Check" :: boolT;
  "Obj_ctime" :: structT Nfstime3
].

Definition SETATTR3args := struct.decl [
  "Object" :: structT Nfs_fh3;
  "New_attributes" :: structT Sattr3;
  "Guard" :: structT Sattrguard3
].

Definition SETATTR3resok := struct.decl [
  "Obj_wcc" :: structT Wcc_data
].
...
Definition SETATTR3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT SETATTR3resok;
  "Resfail" :: structT SETATTR3resfail
].

Definition LOOKUP3args := struct.decl [
  "What" :: structT Diropargs3
].

Definition LOOKUP3resok := struct.decl [
  "Object" :: structT Nfs_fh3;
  "Obj_attributes" :: structT Post_op_attr;
  "Dir_attributes" :: structT Post_op_attr
].
...
Definition LOOKUP3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT LOOKUP3resok;
  "Resfail" :: structT LOOKUP3resfail
].
...
Definition ACCESS3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT ACCESS3resok;
  "Resfail" :: structT ACCESS3resfail
].

Definition READLINK3args := struct.decl [
  "Symlink" :: structT Nfs_fh3
].

Definition READLINK3resok := struct.decl [
  "Symlink_attributes" :: structT Post_op_attr;
  "Data" :: Nfspath3
].
...
Definition READLINK3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT READLINK3resok;
  "Resfail" :: structT READLINK3resfail
].

Definition READ3args := struct.decl [
  "File" :: structT Nfs_fh3;
  "Offset" :: Offset3;
  "Count" :: Count3
].

Definition READ3resok := struct.decl [
  "File_attributes" :: structT Post_op_attr;
  "Count" :: Count3;
  "Eof" :: boolT;
  "Data" :: sliceT byteT
].
...
Definition READ3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT READ3resok;
  "Resfail" :: structT READ3resfail
].
...
Definition WRITE3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT WRITE3resok;
  "Resfail" :: structT WRITE3resfail
].
...
Definition Createhow3 := struct.decl [
  "Mode" :: Createmode3;
  "Obj_attributes" :: structT Sattr3;
  "Verf" :: Createverf3
].

Definition CREATE3args := struct.decl [
  "Where" :: structT Diropargs3;
  "How" :: structT Createhow3
].

Definition CREATE3resok := struct.decl [
  "Obj" :: structT Post_op_fh3;
  "Obj_attributes" :: structT Post_op_attr;
  "Dir_wcc" :: structT Wcc_data
].
...
Definition CREATE3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT CREATE3resok;
  "Resfail" :: structT CREATE3resfail
].

Definition MKDIR3args := struct.decl [
  "Where" :: structT Diropargs3;
  "Attributes" :: structT Sattr3
].
...
Definition MKDIR3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT MKDIR3resok;
  "Resfail" :: structT MKDIR3resfail
].

Definition Symlinkdata3 := struct.decl [
  "Symlink_attributes" :: structT Sattr3;
  "Symlink_data" :: Nfspath3
].

Definition SYMLINK3args := struct.decl [
  "Where" :: structT Diropargs3;
  "Symlink" :: structT Symlinkdata3
].
...
Definition SYMLINK3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT SYMLINK3resok;
  "Resfail" :: structT SYMLINK3resfail
].

Definition Devicedata3 := struct.decl [
  "Dev_attributes" :: structT Sattr3;
  "Spec" :: structT Specdata3
].

Definition Mknoddata3 := struct.decl [
  "Ftype" :: Ftype3;
  "Device" :: structT Devicedata3;
  "Pipe_attributes" :: structT Sattr3
].

Definition MKNOD3args := struct.decl [
  "Where" :: structT Diropargs3;
  "What" :: structT Mknoddata3
].
...
Definition MKNOD3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT MKNOD3resok;
  "Resfail" :: structT MKNOD3resfail
].

Definition REMOVE3args := struct.decl [
  "Object" :: structT Diropargs3
].
...
Definition REMOVE3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT REMOVE3resok;
  "Resfail" :: structT REMOVE3resfail
].
...
Definition RMDIR3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT RMDIR3resok;
  "Resfail" :: structT RMDIR3resfail
].

Definition RENAME3args := struct.decl [
  "From" :: structT Diropargs3;
  "To" :: structT Diropargs3
].

Definition RENAME3resok := struct.decl [
  "Fromdir_wcc" :: structT Wcc_data;
  "Todir_wcc" :: structT Wcc_data
].
...
Definition RENAME3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT RENAME3resok;
  "Resfail" :: structT RENAME3resfail
].

Definition LINK3args := struct.decl [
  "File" :: structT Nfs_fh3;
  "Link" :: structT Diropargs3
].

Definition LINK3resok := struct.decl [
  "File_attributes" :: structT Post_op_attr;
  "Linkdir_wcc" :: structT Wcc_data
].
...
Definition LINK3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT LINK3resok;
  "Resfail" :: structT LINK3resfail
].
...
Definition READDIR3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT READDIR3resok;
  "Resfail" :: structT READDIR3resfail
].
...
Definition Entryplus3 := struct.decl [
  ...
  "Name" :: Filename3;
  "Cookie" :: Cookie3;
  "Name_attributes" :: structT Post_op_attr;
  "Name_handle" :: structT Post_op_fh3;
  "Nextentry" :: ptrT
].
...
Definition READDIRPLUS3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT READDIRPLUS3resok;
  "Resfail" :: structT READDIRPLUS3resfail
].

Definition FSSTAT3args := struct.decl [
  "Fsroot" :: structT Nfs_fh3
].
...
Definition FSSTAT3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT FSSTAT3resok;
  "Resfail" :: structT FSSTAT3resfail
].
...
Definition FSINFO3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT FSINFO3resok;
  "Resfail" :: structT FSINFO3resfail
].
...
Definition PATHCONF3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT PATHCONF3resok;
  "Resfail" :: structT PATHCONF3resfail
].
...
Definition COMMIT3res := struct.decl [
  "Status" :: Nfsstat3;
  "Resok" :: structT COMMIT3resok;
  "Resfail" :: structT COMMIT3resfail
].
...
Definition Fhandle3: ty := sliceT byteT.
...
Definition Mountres3_ok := struct.decl [
  "Fhandle" :: Fhandle3;
  "Auth_flavors" :: sliceT uint32T
].

Definition Mountres3 := struct.decl [
  "Fhs_status" :: Mountstat3;
  "Mountinfo" :: structT Mountres3_ok
].
