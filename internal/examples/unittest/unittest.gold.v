...
Definition Enc__UInt64: val :=
  rec: "Enc__UInt64" "e" "x" :=
    machine.UInt64Put (Enc__consume "e" #8) "x";;
    #().

Definition Enc__UInt32: val :=
  rec: "Enc__UInt32" "e" "x" :=
    machine.UInt32Put (Enc__consume "e" #4) "x";;
    #().
...
Definition Dec__UInt64: val :=
  rec: "Dec__UInt64" "d" :=
    machine.UInt64Get (Dec__consume "d" #8).

Definition Dec__UInt32: val :=
  rec: "Dec__UInt32" "d" :=
    machine.UInt32Get (Dec__consume "d" #4).
...
Definition clearMap: val :=
  rec: "clearMap" "m" :=
    machine.MapClear (mapT uint64T) uint64T uint64T "m";;
    #().
...
Definition stringAppend: val :=
  rec: "stringAppend" "s" "x" :=
    ((#(str"prefix ") + "s") + #(str" ")) + (machine.UInt64ToString "x").
