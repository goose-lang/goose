...
Definition mapClear : go_string := "github.com/goose-lang/goose/testdata/examples/unittest.mapClear"%go.

(* go: maps.go:59:6 *)
Definition mapClearⁱᵐᵖˡ : val :=
  λ: <>,
